...
export async function generateSiteConfig(
  ...
  try {
    ...
    const siteConfig: SiteConfig = {
      ...
      description: extractSiteDescription(prompt) || "Site generated from MCP prompt",
      pages: {
        home: {
          hero: {
            title: extractHeroTitle(prompt) || "Welcome to Our Site",
            subtitle: extractHeroSubtitle(prompt) || "Professional services and solutions for your business needs."
          },
